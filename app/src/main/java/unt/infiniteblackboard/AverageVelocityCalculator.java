...
public class AverageVelocityCalculator extends ActionBarActivity {
    EditText amount1;
    EditText amount2;
    EditText amount3;
    EditText amount4;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(AverageVelocityCalculator.this,
                        MainActivity.class);
    ...
    {
        final AlertDialog.Builder builder1 = new AlertDialog.Builder(AverageVelocityCalculator.this);
