...
public class OneDMotionCalculator extends ActionBarActivity {
    EditText amount1;
    EditText amount2;
    EditText amount3;
    TextView tt;
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        button.setOnClickListener(new OnClickListener() {
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(OneDMotionCalculator.this,
                        MainActivity.class);
    ...
    {
        final AlertDialog.Builder builder1 = new AlertDialog.Builder(OneDMotionCalculator.this);
