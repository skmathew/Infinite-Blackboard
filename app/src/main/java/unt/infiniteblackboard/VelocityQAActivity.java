...
public class VelocityQAActivity extends ActionBarActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                Intent myIntent = new Intent(VelocityQAActivity.this,
                        MainActivity.class);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                ...
                if(correctAnswer.isChecked())
                {
                    ...
                    ScoreKeeper.addPoint(getApplicationContext(), VelocityQAActivity.class.getSimpleName());
                    ScoreKeeper.updateScore(getApplicationContext(),numberCorrectText);
                    button2.setEnabled(true);
